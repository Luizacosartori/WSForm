...
router.get("/treatment/", (request, response) => {
  ...
  console.log(
    'SELECT s.full_name, t.*, cmf.occupation FROM treatment t  JOIN staff s ON s.staff_id=t.staff_id JOIN client_massage_form cmf ON cmf.client_id=t.client_id where date(treatment_StartDateTime) ="' +
      newDate +
